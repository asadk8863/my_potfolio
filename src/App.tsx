...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-sm shadow-sm z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="text-2xl font-bold text-purple-600">Prime Group</div>
            
            {/* Desktop Menu */}
            <div className="hidden md:flex space-x-8">
              <a href="#home" onClick={(e) => handleNavClick(e, 'home')} className="text-gray-700 hover:text-purple-600 transition-colors">Home</a>
              <a href="#about" onClick={(e) => handleNavClick(e, 'about')} className="text-gray-700 hover:text-purple-600 transition-colors">About</a>
              <a href="#services" onClick={(e) => handleNavClick(e, 'services')} className="text-gray-700 hover:text-purple-600 transition-colors">Services</a>
              <a href="#industries" onClick={(e) => handleNavClick(e, 'industries')} className="text-gray-700 hover:text-purple-600 transition-colors">Industries</a>
              <a href="#contact" onClick={(e) => handleNavClick(e, 'contact')} className="text-gray-700 hover:text-purple-600 transition-colors">Contact</a>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200">
              <div className="flex flex-col space-y-2">
                <a href="#home" onClick={(e) => handleNavClick(e, 'home')} className="px-2 py-2 text-gray-700 hover:text-purple-600 transition-colors">Home</a>
                <a href="#about" onClick={(e) => handleNavClick(e, 'about')} className="px-2 py-2 text-gray-700 hover:text-purple-600 transition-colors">About</a>
                <a href="#services" onClick={(e) => handleNavClick(e, 'services')} className="px-2 py-2 text-gray-700 hover:text-purple-600 transition-colors">Services</a>
                <a href="#industries" onClick={(e) => handleNavClick(e, 'industries')} className="px-2 py-2 text-gray-700 hover:text-purple-600 transition-colors">Industries</a>
                <a href="#contact" onClick={(e) => handleNavClick(e, 'contact')} className="px-2 py-2 text-gray-700 hover:text-purple-600 transition-colors">Contact</a>
              </div>
            </div>
          )}
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-8 lg:mb-0">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-4">
                Hi, We're<br />
                <span className="text-purple-600">Prime Group</span>
              </h1>
              ...
              <button className="bg-purple-600 text-white px-8 py-3 rounded-lg hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
                Contact Us
              </button>
            ...
            <div className="lg:w-1/2 flex justify-center">
              ...
              >
                {/* soft glow */}
                <div className="absolute inset-0 -z-10 rounded-full bg-purple-500/20 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                <div
                  className={`w-72 h-72 lg:w-45 lg:h-45 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center shadow-xl transform transition-transform duration-700 ease-out group-hover:scale-105 ${isSpinning ? 'animate-spin' : ''}`}
                ...
                <div className="absolute -bottom-4 -right-4 bg-white p-3 rounded-lg shadow-lg">
                  <span className="text-purple-600 font-semibold">Since 2016</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl p-8 h-80 flex items-center justify-center">
                <div className="text-center">
                  <Users size={80} className="text-purple-600 mx-auto mb-4" />
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-8 mb-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">08+</div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-1 rounded-lg shadow-sm">
                ...
                <div className="bg-gray-200 rounded-lg h-2 mx-4 mb-4">
                  <div className="bg-purple-500 h-2 rounded-lg" style={{width: '100%'}}></div>
                </div>
              </div>
              ...
              <div className="bg-white p-1 rounded-lg shadow-sm">
                ...
                <div className="bg-gray-200 rounded-lg h-2 mx-4 mb-4">
                  <div className="bg-purple-500 h-2 rounded-lg" style={{width: '95%'}}></div>
                </div>
              </div>
              ...
              <div className="bg-white p-1 rounded-lg shadow-sm">
                ...
                <div className="bg-gray-200 rounded-lg h-2 mx-4 mb-4">
                  <div className="bg-purple-500 h-2 rounded-lg" style={{width: '90%'}}></div>
                </div>
              </div>
              ...
              <div className="bg-white p-1 rounded-lg shadow-sm">
                ...
                <div className="bg-gray-200 rounded-lg h-2 mx-4 mb-4">
                  <div className="bg-purple-500 h-2 rounded-lg" style={{width: '98%'}}></div>
                </div>
              </div>
            </div>
      ...
      <section id="industries" className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 reveal">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:shadow-md transition-shadow">
              <HardHat className="mx-auto text-purple-600 mb-3" size={32} />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-purple-50 p-8 rounded-xl">
              <h3 className="text-xl font-semibold text-purple-800 mb-4">Service Rates</h3>
              <p className="text-purple-600">Competitive % on top of wages</p>
            </div>
            
            <div className="bg-purple-50 p-8 rounded-xl">
              <h3 className="text-xl font-semibold text-purple-800 mb-4">Payment Terms</h3>
              <p className="text-purple-600">Net 30 Days</p>
            </div>
            
            <div className="bg-purple-50 p-8 rounded-xl">
              <h3 className="text-xl font-semibold text-purple-800 mb-4">Agreement</h3>
              <p className="text-purple-600">Flexible, non-binding<br />No upfront costs</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-purple-600 text-white py-8 px-4 sm:px-6 lg:px-8">
